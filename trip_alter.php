...
//  $sql = "INSERT INTO trips (header,tripDate,duration,summary,trip_image,tripCost,skillLevel,distance,riverClass,googleMaps,maxSeats)   VALUES ('$header','$tripDate','$duration','$summary','$trip_image','$tripCost','$skillLevel','$distance','$riverClass','$googleMaps','$maxSeats')";

$sql = "UPDATE trips SET header = '$header', tripDate = '$tripDate', duration = '$duration', summary = '$summary', trip_image = '$trip_image', tripCost = '$tripCost', skillLevel = '$skillLevel', distance = '$distance', riverClass = '$riverClass', googleMaps = '$googleMaps', maxSeats = '$maxSeats'WHERE id = $id";
  
  if (mysqli_query($link, $sql)) {
    echo '<div class="form_100">
        <div class="form">
            <h2>New record updated successfully</h2><pre><?= ;?></pre>
